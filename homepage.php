	...
	<body class="homepage">
		...
		<div id="header-wrapper">
        	...
        	<div id="header" class="container">
                ...
                <nav id="nav">
                    <ul>
                        <li class="current_page_item"><a href="homepage.php">Glavna strana</a></li>
                        <li><a href="about.php">O nama</a></li>
                        <li><a href="comment.php">Pišite nam</a></li>
					...
					<div class="row double">
                        ...
                        <section class="4u">
                           <header>
                            ...
                            <span class="pennant"><span class="fa fa-photo"></span></span>
                            <p>Pogledajte našu galeriju slika gde smo bili aktivni. Pridružite nam se na sledećem projektu i budite deo humanitarne akcije.</p>
                            <a href="gallery.php" class="button button-style1">Pogledajte galeriju</a>
                        </section>
                        <section class="4u">
                            <header>
	                            <h2>Kontaktirajte nas</h2>
                            </header>
                            <span class="pennant"><span class="fa fa-id-card-o"></span></span>
                            <p>Ukoliko imate preporuke, Vašem kraju treba čišćenje pošaljite nam poruku ili nas obavestite slanjem mejla na nasču e-mail adresu. </p>
                            <a href="contact.php" class="button button-style1">Pišite nam</a>
                        </section>
                        <section class="4u">
                            <header>
	                            <h2>Novosti</h2>
                            ...
                            <p>Pratite naša dešavanja i pridružite nam se u očuvanju životne sredine. <br><br></p>
                            <a href="#" class="button button-style1">Prošitaj više</a>
                        </section>
